      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-64 space-y-3">
          <div className={`flex gap-3 items-center`}>
            <p
              className={`border-b-2 border-b-border_brown text-xl font-normal text-black_text w-full`}
            >
              Текст здесь1
            </p>
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 space-y-3 bg-border_brown">
                ...
                <div className={`flex justify-between`}>
                  <Button
                    className={`bg-background_section hover:bg-background_hero text-custom_button hover:text-background_section py-2 px-6`}
                  >
                    Reset
                  </Button>
                  <Button
