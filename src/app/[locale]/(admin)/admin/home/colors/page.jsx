...
const categories = [
  {
    id: generateRandomId(),
    name: "Сиановый",
    frame: "/productImages/cyan.png",
  },
  { id: generateRandomId(), name: "Красный", frame: "/productImages/red.png" },
  {
    id: generateRandomId(),
    name: "Мажента",
    frame: "/productImages/majenta.png",
  },
];
  ...
  return (
    <div>
      <div className={`flex gap-5 bg-admin-green py-2 px-3`}>
        <OkIcon />
        <p>Цвет Красный был(-а) успешно добавлена</p>
      </div>
          ...
          {categories.map((item, index) => (
            ...
            >
              ...
              <td className="px-2 flex gap-2 w-[12%]">
                <EditButtonOutline name={item.name} link={"colors"}>
                  Изменить
                </EditButtonOutline>
                <Button className="bg-inherit hover:bg-inherit hover:border-b rounded-none p-0 px-1 duration-700 flex items-center gap-2">
                  <TrashIconWhite /> Удалить
